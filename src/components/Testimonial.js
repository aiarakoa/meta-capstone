...
function Testimonial(props) {
    const images        = {'Bérénice': bereniceImage, 'Clifford': cliffordImage, 'Ibrahima': ibrahimaImage, 'Tilly': tillyImage};
    const altTexts      = {'Bérénice': 'Meet Bérénice', 'Clifford': 'Meet Clifford', 'Ibrahima': 'Meet Ibrahima', 'Tilly': 'Meet Tilly'};
    const reviewTexts   = {
